...
class TestAPICalypse {
    ...
    fun testSearch() {
        ...
        assertEquals("search \"Halo\";f game.name,game.invloved_companies;w game != n;", apiCalypse.buildQuery())
    }
    ...
    fun testSearchWithExclude() {
        ...
        assertEquals("search \"Assassins Creed\";f game.name,game.invloved_companies;w game != n & game.version_parent = n;", apiCalypse.buildQuery())
    }
    ...
    fun testGetAllPS4ANDPCExclusives() {
        ...
        assertEquals("f name,category,platforms;w category = 0 & platforms = {48,6};", apiCalypse.buildQuery())
    }
